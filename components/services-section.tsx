  ...
  return (
    ...
    >
      <section className="flex flex-wrap justify-center gap-4 w-11/12">
        <div>
          <h1 className="text-5xl text-white text-center p-3 pt-8 font-light">
            Explore Beautiful Templates
          </h1>
          <h4 className="text-md text-white/80 text-center pb-4 font-light">
