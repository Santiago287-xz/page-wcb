const App = () => {
  return (
    <section className="h-screen mt-[-3rem] relative">
      <div className="flex flex-wrap flex-col h-full w-full absolute content-center justify-center z-20">
        <div className="flex content-center justify-center flex-wrap flex-col text-2xl sm:text-3xl md:text-6xl w-auto font-light animate-fade-down text-foreground">
        ...
        <p className="w-1/3 mx-auto text-center mt-4 animate-fade-up text-foreground/80">
          <span>
